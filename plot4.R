...
householdGlobalReactivePower <- as.numeric(subSettingData$Global_reactive_power)
...
plot(datetime, householdGlobalActivePower, type="l", xlab="", ylab="Global Active Power", cex=0.2)
...
plot(datetime, householdGlobalReactivePower, type="l", xlab="datetime", ylab="Global_reactive_power")
